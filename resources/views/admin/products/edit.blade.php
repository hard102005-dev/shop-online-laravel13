...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        ...
        <p class="text-muted mb-0">Update product details, pricing, and stock.</p>
    </div>
                ...
                <div class="col-md-6">
                    ...
                    @if ($product->image_path)
                        <div class="mt-3">
                            ...
                            <div>
                                <img src="{{ asset('storage/' . $product->image_path) }}" alt="{{ $product->name }}" class="img-fluid rounded-3" style="max-height: 180px; object-fit: cover;">
                            </div>
                        </div>
                    @endif
                </div>
